...
def read(label):
    ...
    if label ==1:
        test_data = np.load('/home/sandisk/capsulenet/data/word_mix/new/fb_features_ten_test_spkind.npy',encoding = 'bytes')
        train_data = np.load('/home/sandisk/capsulenet/data/word_mix/new/fb_features_ten_train_spkind.npy',encoding = 'bytes')
        print('using speaker independent')
    if label ==2:
        test_data = np.load('/home/sandisk/capsulenet/data/word_mix/new/fb_features_ten_test_spkdep.npy',encoding = 'bytes')
        train_data = np.load('/home/sandisk/capsulenet/data/word_mix/new/fb_features_ten_train_spkdep.npy',encoding = 'bytes')
        print('using speaker dependent')
