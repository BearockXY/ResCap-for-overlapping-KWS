...
class SpeechResModel(nn.Module):
    ...
    def forward(self, x,y_p=None):
        ...
        if y_p is None:  # during testing, no label given. create one-hot coding using `length`
            index1, index2,index3,index4,index5 = find_index(length)
...
def test(model, test_loader, args):
    ...
    for x, y, z, w in test_loader:
        ...
        index_pred1,index_pred2,index_pred3,index_pred4,index_pred5 = find_index(y_pred)
        ...
        result1 = judge_correct(y,z,w,index_pred1.float(),index_pred2.float(),index_pred3.float(),index_pred4.float(),index_pred5.float())
