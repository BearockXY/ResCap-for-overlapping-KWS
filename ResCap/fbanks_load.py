...
def read(label):
    ...
    if label ==1:
        test_data = np.load('/home/xps15/Desktop/capsulenet/data/word_mix/new/fb_features_five_test_spkind.npy',encoding = 'bytes')
        train_data = np.load('/home/xps15/Desktop/capsulenet/data/word_mix/new/fb_features_five_train_spkind.npy',encoding = 'bytes')
        print('using speaker independent')
    if label ==2:
        test_data = np.load('/home/xps15/Desktop/capsulenet/data/word_mix/new/fb_features_five_test_spkdep.npy',encoding = 'bytes')
        train_data = np.load('/home/xps15/Desktop/capsulenet/data/word_mix/new/fb_features_five_train_spkdep.npy',encoding = 'bytes')
